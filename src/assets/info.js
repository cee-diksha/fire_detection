...
export const specificDeviceChartData = [
    ...
    },
    {
        node_type: "sensor", node_name: "MCO", node_id: 108, deck: 1, comp: 9, alertlogstemp: [
            ...
            { time: "17", value: "52", info: "[WARNING]", status: "Temperature rising above critical" },
            { time: "18", value: "56", info: "[WARNING]", status: "Temperature rising above critical" },
            { time: "19", value: "59", info: "[WARNING]", status: "Temperature rising above critical" },
            { time: "20", value: "60", info: "[WARNING]", status: "Temperature rising above critical" },
