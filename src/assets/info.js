export const info = [
    ...
    { id: 8, status: "orange", tempSetpoint: 50, smokeSensor: false, triggeringDevice: null, axis: 'X-Y-Z', node_type: "sensor", node_name: "MCO", node_id: 108, battery_percentage: "100", temp: "65", last_update: "12/9/24 11:54:58", isDeleted: false, deck: 1, compartment: 9 },
    ...
    { id: 11, status: "danger", tempSetpoint: 50, smokeSensor: true, triggeringDevice: null, axis: 'X-Y-Z', node_type: "sensor", node_name: "Spare Gear Store", node_id: 111, battery_percentage: "100", temp: "80", last_update: "12/9/24 11:54:58", isDeleted: false, deck: 4, compartment: 5 },
